...
def main():
    ...
    emb_path = here / f"shorts_embeddings_all-MiniLM-L6-v2_{dim}_v3.parquet"
    emb_df = pd.DataFrame({
        ...
        "config_version": "train_regressor_minilm_v3",
    })
    ...
    reg = Ridge(alpha=ALPHA)
    reg.fit(emb, y)
    model_path = here / "ridge_regressor_v3.pkl"
    ...
    report = here / "training_report_v3.md"
    lines = []
    lines.append("# Regression Head Training Report (v3)\n")
